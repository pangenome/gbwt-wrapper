...
extern "C"  void  GBWT_extend (void* GBWT,  CSearchState  out , CSearchState state, node_type node);
...
extern "C" void    bdExtendForwardGBWT (void* GBWT,void* out, CBidirectionalSearchState state, node_type node);
extern "C" void    bdExtendBackwardGBWT (void* GBWT,void* out, CBidirectionalSearchState state, node_type node) ;
...
extern "C" void  GBWT_get_forward_state(CBidirectionalSearchState, CBidirectionalSearchState);
extern "C" void  GBWT_get_backward_state(CBidirectionalSearchState, CBidirectionalSearchState);
...
extern "C" int sizeof_search_state (void);

extern "C" int sizeof_bi_search_state (void);

extern "C" void* new_search_state ();

extern "C" void  delete_search_state ();

extern "C" void* new_bi_search_state ();

extern "C" void  delete_bi_search_state ();
